  ...
  return (
    <div className='flex  flex-col flex-shrink-0 h-full justify-between p-5  w-[300px] bg-yellow-400 rounded-xl'>
      ...
      <div className='flex justify-between mt-4'>
        <button className='bg-green-700 py-1 px-2 text-sm rounded !text-white'>Mark as completed</button>
        <button className='bg-red-500 py-1 px-2 text-sm rounded !text-white'>Mark as failed</button>
      </div>
